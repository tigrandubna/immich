...
export type SystemConfigNightlyTasksDto = {
    ...
    /** Detect trips and create albums */
    detectTrips?: boolean;
    /** Generate memories */
...
/**
 * Re-detect faces on a single asset
 */
export function redetectFaces({ id }: {
    id: string;
}, opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchText(`/assets/${encodeURIComponent(id)}/redetect-faces`, {
        ...opts,
        method: "POST"
    }));
}
...
export function unassignFace({ id }: {
    ...
    return oazapfts.ok(oazapfts.fetchText(`/faces/${encodeURIComponent(id)}/person`, {
        ...opts,
        method: "DELETE"
    }));
}
 ...
 */
export function getPersonFacesList({ anchor, id }: {
    anchor?: string;
    id: string;
}, opts?: Oazapfts.RequestOpts) {
...
export enum ManualJobName {
    ...
    DetectRecentTrips = "detect-recent-trips",
...
export enum JobName {
    ...
    AutoTripDetectRecent = "AutoTripDetectRecent",
